...
Please refer to the next section on Definitions from <<iec_60601_1_8_2020>> for normative definitions for these terms.

NOTE: Note that the 1.0 version of the SDPi Profile only supports the Distributed Information System (DIS) model detailed below.
...
The following content is extracted directly from the <<iec_60601_1_8_2020>> standard for reference purposes.
