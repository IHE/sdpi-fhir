...
| Responder
| R
| #DEV TF-2:3.26# #TODO insert DEV-26 reference here#
...
| #TODO fix reference: transaction_name_retrieve_biceps_content#
| Responder
| O
...
| Responder
| O
| #DEV TF-2:3.31# #TODO insert DEV-31 reference here#

| <<transaction_name_retrieve_archive_data>>  (_deferred_)
| Responder
| O
| #DEV TF-2:3.32# #TODO insert DEV-32 reference here#

| <<transaction_name_retrieve_localization_information>>
| Responder
| O
| #DEV TF-2:3.33# #TODO insert DEV-33 reference here#

| <<transaction_name_announce_network_departure>>
| Initiator
| R
| #DEV TF-2:3.34# #TODO insert DEV-34 reference here#
