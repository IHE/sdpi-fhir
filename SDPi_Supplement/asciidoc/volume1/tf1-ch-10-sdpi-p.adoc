...
The relevant transactions between them are detailed in the subsequent <<vol1_sdpi_table_actors_transactions>>.
...
<<vol1_sdpi_table_actors_transactions>> lists the transactions for each actor directly involved in the SDPi-P Profile.
...
[#vol1_sdpi_table_actors_transactions]
