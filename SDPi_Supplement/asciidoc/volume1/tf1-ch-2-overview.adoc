...
. If so, should they be added in this SDPi Supplement or should they be added as a separate CP to the main IHE DEV TF (version 2022 or later)?
...
#TODO:  DOES THIS SECTION WITH OPTIONS NEED TO BE DETAILED HERE OR IS IT SUFFICIENT TO HAVE TEMPLATE LANGUAGE POINTING TO THE http://www.ihe.net/Profiles/ PAGE?#
...
#TODO:  Include brief purpose & scope statement for each of the four profiles#
