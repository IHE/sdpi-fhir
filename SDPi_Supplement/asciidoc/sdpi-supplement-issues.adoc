...
** Changes were made in line with https://confluence.hl7.org/display/GP/Topic%3A+SDPi-P+Compression+Option[TOI Page: SDPi-P Compression Option]; In a nutshell, introduced two requirements on gzip compression. This was made in Vol 2, Annex A (sections: #tf2-ch-a-mdpws.adoc# and #tf2-ch-a-mdpws-compression.adoc#).
