...
| An <<acronym_hl7>> standard for health care data exchange, built on RESTful technology that utilizes "resources" to enable rapid creation of interoperable healthcare applications.
|
