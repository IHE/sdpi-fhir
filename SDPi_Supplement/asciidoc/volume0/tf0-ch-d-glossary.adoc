...
| #TODO: Add description and link to See TF-3 description language#
...
|
| [[acronym_ehr,EHR]] EHR
| https://profiles.ihe.net/GeneralIntro/ch-D.html[IHE TF-0 Appendix D Glossary]
| IHE
...
| #TODO: Is there an existing definition, incl. in the IHE DEV TF?#
|
| [[acronym_poc,PoC]] PoC
|
|
...
#TODO: HOLDING PLACE FOR DECLARATION OF LABELS BEFORE THEIR USE ...#
[[acronym_aars,AARS]]
...
// ALSO INCLUDE definitions for:  acronym_agw