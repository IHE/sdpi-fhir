...
| [[term_health_level_seven,Health Level Seven (HL7)]] Health Level Seven
| An ANSI accredited standards development organization.
|
| [[acronym_hl7,HL7]] HL7
| https://www.hl7.org/about/index.cfm?ref=nav[HL7.org/about/]
|
...
| A device that is intended to be used by an individual to track and manage their own health.
|
| [[acronym_phd,PHD]] PHD
|
|
