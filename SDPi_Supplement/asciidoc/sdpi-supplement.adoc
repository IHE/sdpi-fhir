...
:imagesoutdir: images/
:imagesdir: images/
:title-logo-image: image::ihe-logo.svg[pdfwidth=4in,align=center]
:docinfo: shared

#WHY DOESN'T TITLE-LOGO-IMAGE SHOW UP AT TOP OF TITLE PAGE?#
...
WARNING: #The ToC should come AFTER the Forward section - but it is on the sidebar ... do we just note this in the source?#
