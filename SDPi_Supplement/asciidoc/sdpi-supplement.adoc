...
image::ihe-logo.svg[pdfwidth=4in,align=center]
...
^|
++++
<p style="font-size: 30pt"><strong>IHE Devices</strong></p>

<p style="font-size: 30pt"><strong>Technical Framework Supplement</strong></p>

// {empty} +
// {empty} +

<p style="font-size: 30pt"><strong>Service-oriented Device Point-of-care</strong></p>

<p style="font-size: 30pt"><strong>Interoperability (SDPi)</strong></p>
