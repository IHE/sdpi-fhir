...
#TODO: The content for this retrofit file better fits in TF-2 Appendix A than in TF-3 Semantic Content OR perhaps split between the two. The focus of this is on HOW to communicate (TF-2) vs. WHAT to communicate (TF-3).#
