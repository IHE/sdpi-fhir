...
[plantuml#vol3-figure-biceps-content-module-physiomon, target=puml-figure-biceps-content-module-physiomon, format=svg, reftext='{figure-caption} {counter:refnum}',width=100%]
....
