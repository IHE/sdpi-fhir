...
Consequently, a manufacturer of a <<actor_somds_provider>> should be careful with defining extension with `@ext:MustUnderstand = true`, as this potentially reduces interoperability.
