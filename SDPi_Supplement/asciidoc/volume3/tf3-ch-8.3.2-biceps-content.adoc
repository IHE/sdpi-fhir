...
****
All <<acronym_somds_participant>> systems shall fully implement the semantic content requirements in the <<ref_ieee_11073_10207_2017>> <<acronym_biceps>> standard.
...
[#vol1_table_system_type_nomenclature_extension]
...
.^| Gateway
.^| (tba)
.^| Gateway PARTICIPANT that provides, for example, ADT information or laboratory results (inbound)
