...
* <<ieee_11073_10207_2017>> Section 7.3 Service Model
...
====== Message Semantics
[[payload_dev_25_get_metadata_biceps_services]]BICEPS Services:: Collection of BICEPS services the <<actor_somds_provider>> offers, including but not limited to one or multiple of the following BICEPS services (<<ieee_11073_10207_2017>> Section 7.3 Service Model):
