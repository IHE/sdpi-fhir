...
`s12:Envelope/s12:Body/wsm:Metadata/wsm:MetadataSection/dpws:ThisModel`:: The <<actor_somds_provider>>'s maps to the <<message_semantics_discover_biceps_services_model>> metadata.

`s12:Envelope/s12:Body/wsm:Metadata/wsm:MetadataSection/dpws:ThisDevice`:: The <<actor_somds_provider>>'s maps to the <<message_semantics_discover_biceps_services_device>> metadata.
