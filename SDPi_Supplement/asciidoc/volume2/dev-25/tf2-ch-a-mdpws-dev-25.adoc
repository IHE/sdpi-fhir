...
:var_ref_biceps_service_model: <<ieee_11073_10207_2017>> Section 7.3 Service Model
...
* <<ref_ws_transfer_2006>> {var_uri_ws_discovery_transfer}[Section 3.1 Get]
* <<ref_dpws_2009>> {var_uri_dpws}[Section 4]
