...
This transaction is intended to execute over *_UNSECURED_* connections.
...
Appropriate security risk management shall be performed to ensure that no unintended information is disclosed during *_UNSECURED_* exchange.
