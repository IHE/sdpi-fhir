...
|Listens for <<vol2_clause_dev_23_message_announce_network_presence>> messages  to identify any provider systems that it may want to establish a connection with and further discover a provider’s service capabilities.
