...
* <<ref_ws_discovery_2009>> {var_uri_ws_discovery_hello}[Section 4.1 Hello]
...
To mitigate this, <<actor_somds_provider>>s are advised to create Hello messages of less than the MTU size over UDP, in accordance with the <<ref_dpws_2009>> requirement R0029.

Moreover, as further mitigation measure, note that <<ref_soap_over_udp_v1_1>> already defines a non-normative retry and back-off algorithm.
