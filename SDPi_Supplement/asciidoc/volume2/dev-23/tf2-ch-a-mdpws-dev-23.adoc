...
[%collapsible]
====
To mitigate this, <<actor_somds_provider>>s are advised to create Hello messages of less than the MTU size over UDP, in accordance with the DPWS requirement R0029.
====
