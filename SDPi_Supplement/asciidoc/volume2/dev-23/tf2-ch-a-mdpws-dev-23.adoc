...
<<ieee_11073_20701_2018>> leverages UDP for service discovery and hence suffers from the aforementioned issues.

.Note
[%collapsible]
====
To mitigate this, <<actor_somds_provider>>s are advised to create Hello messages of less than the MTU size over UDP, in accordance with the <<dpws_2009>> requirement R0029.
====
