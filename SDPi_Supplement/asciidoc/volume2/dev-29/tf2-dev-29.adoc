...
The {var_label_dev_29_message_notification} message is sent whenever a report of a <<actor_somds_provider>> is updated and a <<actor_somds_consumer>> is subscribed to reports of a <<actor_somds_provider>>.
