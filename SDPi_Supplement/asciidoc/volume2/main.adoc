...
:var-label-message-interaction-diagram: Message Interaction Diagram for
:var-label-actor-roles: Actor Roles for
:var-label-trigger-events: Trigger Events
:var-label-message-semantics: Message Semantics
:var-label-expected-actions: Expected Actions
:var-label-actor: Actor
:var-label-role: Role
