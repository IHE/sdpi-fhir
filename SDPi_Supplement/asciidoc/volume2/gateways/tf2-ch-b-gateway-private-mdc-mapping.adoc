...
|Text
|"*MDC_PRIVATE_*<CWE-1>"
|Since this is a private code, a MDC RefId does not exist for the code. The field is to be set to a private RefId, which consists of the prefix *"MDC_PRIVATE_"* plus the private code set in CWE-1.
