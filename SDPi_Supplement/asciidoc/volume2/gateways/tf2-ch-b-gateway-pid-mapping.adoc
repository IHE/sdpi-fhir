...
If the SDC patient context information is not intended to be used for the mapping, please refer to the <<ihe_pcd_tf_2_2019>> on how to populate the fields of the PID segment in this case.
****
...
Please refer also to the corresponding section in the <<ihe_pcd_tf_2_2019>>.
...
****
A <<actor_somds_dec_gateway>> shall set the PID-31 field to an indicator whether the patient's identity is known.
