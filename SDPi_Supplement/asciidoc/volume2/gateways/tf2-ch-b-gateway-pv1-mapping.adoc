...
If the SDC patient and/or location context information shall not be used for the mapping, please refer to the <<ihe_pcd_tf_2_2019>> on how to populate the fields of the PV1 segment in this case.
****
