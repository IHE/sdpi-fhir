...
The HL7 Message Header (MSH) segment does not require a specific mapping between the SDC MDIB content and the HL7 ACM profile messages. In context of this chapter, the MSH segment content shall be in compliance with the [PCD-04] transaction as described in the <<ihe_pcd_tf-2_2019>>.
