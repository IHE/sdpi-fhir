...
NOTE: The date/time to be set in the OBX-14 field relates to the alert event phase. Table <<ref_tbl_acm_obx14_alert_phase_mapping>> defines the date/time mapping per alert event phase.
