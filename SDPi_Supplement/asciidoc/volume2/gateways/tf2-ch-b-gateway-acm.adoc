...
|pm:Mds or pm:Vmd or pm:Channel/pm:Type/@Code
...
|OBX-3/CWE-1
|Identifier
|pm:AlertConditionDescriptor/pm:Type/@Code
|
...
|OBX-5
|Observation Value
|pm:AlertConditionDescriptor/pm:Type/pm:ConceptDescription
|
...
|OBX-5/CWE-1
|Identifier
|pm:Mds or pm:Vmd or pm:Channel or pm:Metric/pm:Type/@Code
|
...
|alarm-paused
|*pm:AlertConditionState/@Presence* set to  *"true"* AND all *pm:AlertSignalState* elements have their *@ActivationState* set to *"Psd"*

|alarm-off
|*pm:AlertConditionState/@Presence* set to  *"true"* AND all *pm:AlertSignalState* elements have their *@ActivationState* set to *"Off"* OR have their *@ActivationState* set to *"On"* and *@Presence* set to *"Off"*
...
|OBX-5
|Observation Value
|if *pm:AlertConditionState/@ActualPriority* is available, use pm:AlertConditionState/@ActualPriority

Otherwise, use pm:AlertConditionDescriptor/@Priority
...
|OBX-5
|Observation Value
|pm:AlertConditionDescriptor/@Kind
