...
<<ihe_pcd_tf-2_2019>> defines that the alarm ranges of a numeric metric shall be set in this field on the metric level. Since SDC does not provide this information, the field shall be left empty.
