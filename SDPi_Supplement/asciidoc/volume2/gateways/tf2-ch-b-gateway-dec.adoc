...
[cols="1"]
|===
a| *SDPi Supplement Version Note*:  For SDPi 1.0 DEV Internal Review Version, this profile section needs to be updated in order to be compliant with the <<ref_ihe_pcd_tf_2_2019>>. The following issues need more investigations and discussions:
