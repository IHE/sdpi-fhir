...
A <<actor_somds_dec_gateway>> shall set the OBR-7 field to the date and time of all continuously (peridoically) measured metrics reported by a *msg:PeriodicMetricReport* to be exported within the same *msg:RetrievabilityInfo/@UpdatePeriod*.
