...
****
A <<actor_somds_dec_gateway>> shall assign the handles (which are required to be unique in the same MDIB sequence) of the containment tree elements representing MDSs, VMDs, channels and metrics to unique integer numbers per child level of the same parent.
