...
* <<ref_ws_discovery_2009>> {var_uri_ws_eventing_subscribe}[Section 3.1 Subscribe]
* <<ref_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_ws_discovery_2009>> {var_uri_ws_eventing_notification}[Section 4 Notifications]
* <<ref_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_ws_discovery_2009>> {var_uri_ws_eventing_renew}[Section 3.2 Renew]
* <<ref_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_ws_discovery_2009>> {var_uri_ws_eventing_unsubscribe}[Section 3.4 Unsubscribe]
* <<ref_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_ws_discovery_2009>> {var_uri_ws_eventing_unsubscribe_response}[Section 3.4 Unsubscribe]
* <<ref_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_ws_discovery_2009>> {var_uri_ws_eventing_subscription_end}[Section 3.5 Subscription End]
* <<ref_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
